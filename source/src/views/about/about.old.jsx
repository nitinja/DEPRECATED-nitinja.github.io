...
export default () => {
  return (
    <div>
      ...
      <br />
      <p>
        I am lead artist and frontend developer (<a href="https://github.com/nitinja">
          github
        </a>). I love designing polished UIs for products using cutting-edge
        tech. My passion? Creating beautiful, simplistic products.
      </p>
      <p>
        I am working in the industry around 10 years and worked for industry
        leaders like Persistent systems and startups like QIO. I have done UX
        design for HP and other companies. Here is my
      ...
      <p>
        ...
        <a href="https://medium.com/@nitinj">articles</a>, read sci-fi and
        comics (own nice collection of comics), play computer games and have fun
        with my beautiful wife and cute 1-year old
